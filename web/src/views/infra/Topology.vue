...
<script setup>
  ...
  const json_data = {
      "nodes":[
        {"name":"me", "type": "user", "x": 0, "y": 0, "description": "Me. Tipene. Hybrid developer/operator/user"},
        {"name": "customers", "type": "user", "x": 0, "y": 0, "description": "Public users ingressing through the traefik public node"},
        {"name": "opeators", "type": "user", "x": 0, "y": 0, "description": "Admin users who operate and maintain the cluster"},
        {"name": "leader", "type": "system", "x": 0, "y": 0, "description": "Consul and nomad server that orchestrate and administrate the entire system", "context": `# Leader ASG
