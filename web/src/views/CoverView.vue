<template>
  <div class="row min-vh-100 h-100">
    ...
    <div class="col cover-letter">
      ...
      <p>Now, 7 years on, I feel I have a solid handle on building and servicing dependanble build and tooling platforms, taking pride in my work and delivering solutions tailored to easing burdens, and reducing toil. I'm not afraid to roll up my sleeves, step into the fray and get stuck in on important, yet uncelebrated work, seeing it through to keep everyone on track and chugging along. I'm highly motivated to solve tricky problems, build solutions, and be a part of a dynamic team. Hopefully what you find here is enough to pique your curiosity and give you a sense of my capabilities. I believe I can bring value to you and your team, and I eagerly await hearing from you about what we might build together next.</p>
